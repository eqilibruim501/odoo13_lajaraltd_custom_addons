...
class AccountInvoiceReport(models.Model):
    ...
    def _select(self):
        return super(AccountInvoiceReport, self)._select() + """
            , move.care_of_partner_id as care_of_partner_id
            , move.care_of_percentage as care_of_percentage
            , move.care_of_commission as care_of_commission
        """
    ...
    def _group_by(self):
        return super(AccountInvoiceReport, self)._group_by() + """
            , move.care_of_partner_id
            , move.care_of_percentage
            , move.care_of_commission
        """
