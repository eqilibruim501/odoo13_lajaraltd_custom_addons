...
class AccountMove(models.Model):
    ...
    @api.depends('invoice_line_ids.price_subtotal', 'amount_untaxed', 'currency_id', 'company_id', 'invoice_date', 'type')
    def _compute_amount(self):
        """Compute C/O Commission Amount"""
        res = super(AccountMove, self)._compute_amount()
        for inv in self:
            inv.care_of_commission = inv.amount_untaxed * inv.care_of_percentage
        return res
